...
import { FileText, Code, Award, Globe, ArrowUpRight, Sparkles, Briefcase } from "lucide-react"
import AOS from 'aos'
import 'aos/dist/aos.css'
import Image from "next/image";


// Memoized Components remain unchanged
const Header = memo(() => (
...
const AboutPage = () => {
  ...
  // Calculate experience and load data
  useEffect(() => {
    ...
    // Set default values
    setTotalProjects(3); // Example default value
    setTotalCertificates(2); // Example default value
  ...
  const statsData = [
    {
      ...
      description: "Bringing Social Change To The World",
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              <a href="#Portofolio" className="w-full lg:w-auto">
                ...
                >
                  <Briefcase className="w-4 h-4 sm:w-5 sm:h-5" /> View Projects
                </button>
              </a>
            </div>
          </div>
